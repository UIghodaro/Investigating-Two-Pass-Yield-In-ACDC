...
try:
    ...
    # torchtyping 0.1.4 is incompatible with torch 2.x (_TensorBase no longer subclassable).
    # TT is used only as a type annotation so a subscriptable dummy is sufficient.
    class TT:
        def __class_getitem__(cls, item): return cls
    def patch_typeguard(*args, **kwargs): pass
